...
const createBlog = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ status: "error", message: "Error creating blog post" });
  }
};
...
const getBlogById = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ status: "error", message: "Error fetching blog post" });
  }
};
...
const updateBlog = async () => {
  try {
    ...
    res
      .status(500)
      .json({ status: "error", message: "Error updating blog post" });
  }
};
...
const deleteBlog = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ status: "error", message: "Error deleting blog post" });
  }
};
